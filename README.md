...
## Perspectives
- Vérifier si le résultats des variants des gènes différentiellement exprimés n'est pas lié à un effet taille: regarder nombre de variants et nombre de positions hétérozygotes pour environ 90 gènes (même nombre de gènes que les gènes différentiellement exprimés) choisis alétaoirement 
- Regarder si les variants sont identiques entre les réplicats et entre les G7 et G0
- Voir s'il y a un lien entre expression des gènes nombre de variants
